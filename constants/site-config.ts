...
export const STATS = [
  { num: "500+", label: "Projects & trainings completed" },
  { num: "20+", label: "Years of experience" },
  { num: "800+", label: "Professionals trained" },
  { num: "5+", label: "Countries served" },
] as const;

export const SERVICES = [
  {
    image: "/images/computer-training.png",
    title: "Computer Training",
    description: "Computer Software & Hardware courses for Corporates and Individuals.",
    features: ["Software Training", "PC Hardware Upgrade", "Complete Computer Setup", "Custom Build", "And More"],
  },
  {
    image: "/images/computer-training.png",
    title: "Computer Programming",
    description: "Specialized training in C, C++, Java, Python, and more coding languages.",
    features: ["C / C++", "Java", "Python", "Web Development", "And More"],
  },
  {
    image: "/images/computer-training.png",
    title: "Professional Courses",
    description: "Engineering software training — Revit, AutoCAD, 3DS Max, and BIM from scratch to advanced.",
    features: ["Revit", "AutoCAD", "3DS Max", "BIM 360", "And More"],
  },
  {
    image: "/images/computer-training.png",
    title: "Consultancy",
    description: "End-to-end project design and delivery — concept to completion on time.",
    features: ["Project Planning", "Design Review", "Site Supervision", "Delivery Management", "And More"],
  },
  {
    image: "/images/computer-training.png",
    title: "Architecture",
    description: "Our architects visit your premises and deliver the best aesthetic solution.",
    features: ["Site Visit", "3D Modeling", "Interior Design", "Exterior Design", "And More"],
  },
  {
    image: "/images/computer-training.png",
    title: "Safety Service",
    description: "Building safety equipment, engineers, and labour to keep your site compliant.",
    features: ["Safety Audit", "PPE Supply", "Trained Engineers", "Compliance Reports", "And More"],
  },
] as const;
...
export const SUSTAINABILITY_CONTENT = {
  ...
  right: {
    ...
    subtitle: "We are always challenging ourselves to get the best in the industry.",
    image:
